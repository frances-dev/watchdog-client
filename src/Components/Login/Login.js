...
import {initializeLoginFramework, handleGoogleSignIn,resetPassword, createUserWithEmailAndPassword, signInWithEmailAndPassword,} from './loginManager';
        ...
        <div className="col-sm-12">
          {!newUser ? (
            <form
              ...
              className='login-form shadow bg-white rounded text-left p-3 w-50 mt-5'
            >
              <h4 className='font-weight-bold mb-4 text-center'>Login with your account</h4>
              ...
              <div className='social-login align-items-center'>
                <button className ="btn btn-light w-75" onClick={googleSignIn}>
