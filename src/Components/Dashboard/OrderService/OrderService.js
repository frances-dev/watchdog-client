...
const OrderService = () => {
    ...
    const onSubmitEvent = () => {
        ...
        fetch('https://secure-island-68647.herokuapp.com/addOrder', {
            method: 'POST',
            body: formData
        })
                    ...
                    <div className="adminService p-4">
                        <form action="" onSubmit={handleSubmit(onSubmitEvent)}>
                            <section className="orderServe mt-1">
                                ...
                                <p className="text-danger text-center mt-3">Please make sure you have clicked all the input tab before submitting</p>
                                <button style={{ fontSize: "12px" }} className="btn btn-warning w-100 p-3" type="submit">Order Services</button>
